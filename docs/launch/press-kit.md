...
| **Launch date** | [Date] |
| **Price** | £49 lifetime (no subscriptions) |
| **Free tier** | 50 items, full-text search, 1 board |
| **Platforms** | Web app (Next.js), Chrome extension |
| **Stack** | Next.js 14, React, Tailwind, TypeScript |
| **Storage** | Local JSON files (no cloud required) |
...
The average knowledge worker has saved content scattered across 5+ platforms — Instagram, YouTube, X, TikTok, Reddit, Pocket. Most of it is never seen again. Bookmarks and native "save" features are digital graveyards: content goes in, nothing comes out.
...
**Local-first by design.** Your data lives in a JSON file on your machine. No cloud lock-in, no data mining, no acquisition risk. The only external calls are to your own LLM provider (OpenAI, Anthropic, etc) — your key, your cost, your control.

**Pricing that respects users.** £49 lifetime. No subscriptions. No feature gates. The "bring your own LLM key" model means zero inference cost to the developer — that's how lifetime pricing works without burning cash.

---

## Key Facts

- **Import sources:** Instagram, YouTube, X, TikTok, Reddit, Pocket (more coming)
- **AI features:** Auto-summaries, tag generation, entity extraction, sentiment analysis
- **Search:** Semantic (vector) search + full-text search
- **Knowledge graph:** Force-directed visualisation of connected saves
- **Export:** Obsidian markdown with wikilinks and frontmatter
- **Chrome extension:** Auto-sync from Instagram and X as you save
- **Shareable boards:** Public URLs for curated collections
- **Free tier:** 50 items, full-text search, manual import, 1 board
- **Pro tier:** Unlimited items, AI search, AI enrichment, knowledge graph, unlimited boards, Chrome extension, Obsidian export, priority support
...
> "I found a YouTube video I saved 8 months ago about TypeScript generics. I'd been looking for it for weeks." — [User name]

> "The knowledge graph connected my React saves to my Next.js saves to my Vercel saves. I didn't realise I had a deployment workflow documented across three platforms." — [User name]
...
1. **Dashboard** — Clean interface showing imported items from multiple platforms
2. **Semantic Search** — Search bar with query "that video about Mars colonization" showing relevant results
3. **Knowledge Graph** — Force-directed graph with connected nodes (Rust video, Reddit thread, tweet)
4. **Board Creation** — Organising saves into a curated board with shareable URL
5. **Chrome Extension** — Saving from X/Instagram with one click
6. **Obsidian Export** — Markdown files with wikilinks and frontmatter

### Download Links

[Link to Google Drive / Dropbox folder with high-res PNGs]

**Naming convention:**
- `savedbrain-dashboard-1920x1080.png`
- `savedbrain-semantic-search-1920x1080.png`
- `savedbrain-knowledge-graph-1920x1080.png`
- `savedbrain-boards-1920x1080.png`
- `savedbrain-extension-1920x1080.png`
- `savedbrain-obsidian-export-1920x1080.png`
...
| Secondary | #[hex] | Highlights, tags |
| Background | #[hex] | App background |
| Text | #[hex] | Body text |

[Link to brand asset folder]

---

## Contact Information

**Press enquiries:** [your-email@example.com]
**General enquiries:** [your-email@example.com]
**Twitter/X:** @[your-handle]
**GitHub:** https://github.com/manazoid4/saved-brain
**Website:** https://savedbrain.app (or GitHub README)

**Availability for interviews:** [Your timezone], weekdays 09:00-18:00 GMT
...
- **Indie Hackers:** [Link after launch]
- **LinkedIn:** [Link]

---

## Changelog (Post-Launch Updates)

| Date | Update |
|------|--------|
| [Launch date] | v1.0 — Initial launch |
| [Date] | [Update description] |

---

*Last updated: [Date]*
*For the latest information, visit https://github.com/manazoid4/saved-brain*
